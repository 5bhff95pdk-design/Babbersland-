...
|---|---|---|
| `images/babette_marine.png` | Portrait de la princesse fondatrice de Port Babette (Génération II), cité en tête de section | Aucune image, et le renvoi `(\`images/…\`)` est **effacé** par `rich()` |
