...
**Campagnes 2026-V & 2026-VI** · Dossier `images/realistes/`

---

## 🌟 Vue d'ensemble

Afin de donner vie au Royaume du Babberland, **quatre-vingt-une (81)** photographies ultra-réalistes en haute définition sont versées au portail interactif (`index.html`).

La campagne 2026-V complète la série 2026-II : les **18 figures du canon** ont désormais chacune un cliché, puis les **cinq régions** et les **offices du Livre VIII**. La campagne 2026-VI y ajoute le **bestiaire royal** (Titre III du guide gastronomique). Les photographies capturent les lieux canoniques, les figures historiques, l'architecture, la numismatique, la faune et l'humour caractéristique de la nation.
...
**Diffusion (30 août 2026)** : le portail charge en grille des **vignettes WebP de 640 px** dérivées de ces maîtres (`images/vignettes/`, générées par `make vignettes`, 232 Mio → 4,96 Mio) ; le cliché pleine taille du dossier `images/realistes/` reste **un clic plus loin**, dans la visionneuse. Les maîtres ne sont pas modifiés — le scellé d'iconographie et la sortie prévue en LFS (R1.6, `gouvernance/LFS_MIGRATION.md`) les concernent, pas les vignettes.

---

## 🖼️ Inventaire Complet de la Galerie (81 Photos)

### Série 2026-II (16)

| Fichier | Sujet / Personnage | Description & Ambiance |
|---|---|---|
| `images/realistes/babber_ier_l_ancien.png` | **Babber Ier l'Ancien (1798–1889)** | Portrait photoréaliste du Roi fondateur écrivant la Constitution sur la nappe vichy le 12 octobre 1847, en compagnie du castor patriote. |
| `images/realistes/poutine_royale_et_pabst.png` | **La Poutine Royale & Pabst** | Photographie culinaire d'une poutine fumante au fromage en grain *kouik-kouik* et sauce brune, à côté d'une canette glacée à 3,2 °C. |
| `images/realistes/pabst_city_et_double_aqueduc.png` | **Pabst City & Double Aqueduc** | Panorama du Double Aqueduc de François-Babber (1904) aux Arches Jumelles. |
| `images/realistes/babber_ier_le_louche.png` | **S.M. Babber Ier le Louche** | Portrait régnant, béret couronné, Louche d'Or et Pabst fraîche. |
| `images/realistes/babber_le_dormeur_hamac.png` | **Babber le Dormeur (1875–1959)** | Le Roi du Silence dans son hamac de parade, 45 ans de règne horizontal. |
| `images/realistes/mcbabbers_premier_comptoir_1986.png` | **McBabber's (1986)** | Cliché vintage d'octobre 1986, première taverne en bois rond. |
| `images/realistes/port_babette_et_phare.png` | **Port Babette & Phare Couronné** | Quais en bois et phare blanc surmonté de la couronne. |
| `images/realistes/les_monts_froisses.png` | **Les Monts Froissés (1,20 m)** | Alpes nationales du 15 juillet 1962, franchies d'une enjambée. |
| `images/realistes/babette_ire_plantagenet.png` | **Babette Ire de Plantagenet** | Reine consort fondatrice tricotant la nappe vichy sacrée. |
| `images/realistes/francois_babber_aqueducien.png` | **François-Babber l'Aqueducien** | Grand Ingénieur et plans du Double Aqueduc. |
| `images/realistes/princesse_babette_marine.png` | **Princesse Babette-Marine** | Longue-vue en cuivre sur le port, vers 1900. |
| `images/realistes/colette_pabst_babbersgate.png` | **Reine Colette-Pabst (1991)** | Commission Royale du Babbersgate, marteau de buis. |
| `images/realistes/reine_linea_sauce_secrete.png` | **Reine Linéa & Sauce Secrète** | Première Gardienne touillant le chaudron d'argent. |
| `images/realistes/rambo_du_fjord.png` | **Prince Rambo du Fjord** | Grand Pêcheur, canne en frêne sans hameçon. |
| `images/realistes/police_de_la_sieste.png` | **La Garde Dormante** | Patrouille en pantoufles et bonnets de nuit, 13 h–15 h. |
| `images/realistes/pieces_monnaie_coffret.png` | **Coffret Monétaire Proof 2026** | Babbers bimétalliques et Babetons. |

### Série 2026-V (8) — les figures encore sans cliché

| Fichier | Sujet / Personnage | Description & Ambiance |
|---|---|---|
| `images/realistes/hortense_du_grain.png` | **Hortense du Grain (1840–1922)** | Princesse Consort de l'Aqueduc, épi d'orge et fiole de petit-lait, réserve céréalière. |
| `images/realistes/irene_des_erables.png` | **Irène des Érables (1882–1966)** | Reine Consort du Silence, châle d'automne, sirop d'érable et castor de compagnie. |
| `images/realistes/babber_ii_piscineux.png` | **Babber II le Piscineux (1912–2002)** | Roi Baigneur, mini-pelleteuse, piscine royale et Monts Froissés de 1,20 m. |
| `images/realistes/honore_pabst_henri_grain.png` | **Honoré-Pabst & Henri-Grain (nés 1938)** | Union des Règnes : l'un signe (jours impairs), l'autre dort (jours pairs). |
| `images/realistes/babber_le_fou.png` | **Prince Babber le Fou (né 1986)** | Héritier présomptif, spatule de bois et ballon jaune, né à l'ouverture de McBabber's. |
| `images/realistes/ginette_de_port_babette.png` | **Princesse Ginette (née 1988)** | Dame de la Sauce : louche d'argent couronnée, pot scellé, phare à la fenêtre. |
...
| `images/realistes/phare_blanc_couronne.png` | **Phare couronné** | Port Babette, lanterne à couronne d'or. |
| `images/realistes/quais_port_babette.png` | **Quais d'épinette** | Fromage, barriques, filets. |
| `images/realistes/salle_du_hamac.png` | **Salle du hamac** | Trône de soie bleu roi, Livre III. |
| `images/realistes/place_on_s_assoit.png` | **Place où l'on s'assoit** | Hamacs, rocking-chairs, Pabst City. |
| `images/realistes/flottille_port_babette.png` | **Flottille** | Crépuscule, filets, phare au loin. |
| `images/realistes/ginette_sauce_2024.png` | **Ginette, 2024** | Remise du Secret Brun. |
| `images/realistes/mini_mclouches.png` | **Mini-McLouches** | Jouets de bois, poutine miniature. |
...
Les 81 photographies sont consultables dans le portail :

- **Fichier principal** : `index.html`
- **Onglet dédié** : `📸 Galerie Photos Réalistes` (filtres : Tous · Personnages · Lieux · Faune · Institutions · Table & Monnaie)
...
- **Visionneuse** : clic pour agrandir

Les 28 maîtres d'`images/*.png` (volume 2026-I) ne sont **pas** modifiés.
