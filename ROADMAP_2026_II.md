...
| **R1.4.a** | **Empreinte sémantique de l'Atlas** | ⏳ **Reprise du 1ᵉʳ septembre 2026** (PR #24) : diagnostic local OK, mais l'étape échoue en CI (run #12). Cause probable : cache pip Pillow sur le runner. L'instrumentation capture désormais le diff et le sha256sum en cas d'échec. **R1.4.a-v2** à faire : (a) image Docker épinglée, ou (b) empreinte sémantique de l'Atlas analogue à `pdf_fingerprint.py`. Voir `gouvernance/CI_LIMITES.md` § « Statut R1.4.a ». | 1 h | R1.1 |
