...
| **R2.8** | **Chroniques, Livre II — *Le Silence et l'Aqueduc* (1889–1914)** | **Livré en proposition le 28 août 2026** : `chroniques/LIVRE_II_LE_SILENCE_ET_L_AQUEDUC.md` (*Les Bâtisseurs · Le Silence et l'Aqueduc*, les deux titres annoncés étant gardés côte à côte, conseil nº 2 oblige) — 7 tranches (régence de Babette, refus de l'ordinal, les bancs d'abord, la conversation, les Arches, le Jour de l'Eau du 12 octobre 1904, la Décennie tranquille et l'avènement du Dormeur), bandeau « proposé, non décrété », audit d'arithmétique interne **étendu à 18 calculs, 0 erreur** (standard Livre I : 12), 4 planches de chantier hors volume (Annexe C) et concordance des cotes. Reste au décret : incorporation éventuelle au canon par Avis (rien n'est entré dans 2026-I). | 4-5 j | — |
...
**Reste ouvert** : R1.2 (matrice macOS/Windows), R1.3 (manifeste complet), R1.4 (CI de bout en bout — l'ossature est là), R1.5 (**re-poser `v2026-I` sur `main` + Release**, à faire avec un accès aux étiquettes), R1.6 (maîtres PNG hors dépôt), R1.7 (source unique de l'arbre), l'horizon 2 sauf **R2.6 livré en proposition** (atlas temporel, 2026-I intact, Avis n° 7 restant — voir `geographie/ROADMAP.md`).
