...
| R2.8 | Livré en proposition le 28 août 2026 : `chroniques/LIVRE_II_LES_BATISSEURS.md`, 7 tranches, 1889–1914, bandeau « proposé, non décrété » conforme, **2026-I intact** | Le titre retenu est celui que la fin du Livre I annonçait déjà — ***Les Bâtisseurs*** — et non le titre de travail de la roadmap (*Le Silence et l'Aqueduc*) ; la chronique a priorité sur la fiche. Aucune lacune volontaire comblée : filiation de Babette-Marine, naissance de Roger Bontemps et Parité Poutine chiffrée restent ouvertes et sont nommément déclarées telles dans le texte |

**Reste ouvert** : R1.2 (matrice macOS/Windows), R1.3 (manifeste complet), R1.4 (CI de bout en bout — l'ossature est là), R1.5 (**re-poser `v2026-I` sur `main` + Release**, à faire avec un accès aux étiquettes), R1.6 (maîtres PNG hors dépôt), R1.7 (source unique de l'arbre), l'horizon 2 sauf **R2.6 et R2.8 livrés en proposition** (atlas temporel et Chroniques Livre II, 2026-I intact, Avis n° 7 restant — voir `geographie/ROADMAP.md`).
