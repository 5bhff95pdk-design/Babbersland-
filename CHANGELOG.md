...
* **Portail** (`index.html`) : héro du Double Aqueduc, cartes illustrées des cinq régions, dictionnaire des personnages illustré, chroniques et institutions en planches, galerie filtrable (44 photos) et visionneuse.
* `GALERIE_PHOTOS_REALISTES.md` : inventaire porté de 16 à 44, statut hors volume 2026-I rappelé.
